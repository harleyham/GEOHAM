...
//    cv::destroyAllWindows();
    ...
    ui->txt_Output->setText(" Diretório de imagens do Drone: " + Informacao.Diretorio);
...
{
    auto actSelectAllImgs = new QAction("Marca todos", this);
    auto actDeSelectAllImgs = new QAction("Desmarca todos", this);
...
void MainWindow::Cria_Contex_Menu_Imgs_2()
{
    ...
    actSelectAllImgs = new QAction("Marca todos", contextMenu);
    actDeSelectAllImgs = new QAction("Desmarca todos", contextMenu);
...
void MainWindow::Cria_Contex_Menu_Proc()
{
    ...
    actSelectAllProc = new QAction("Marca todos", contextMenuProc);
    actDeSelectAllProc = new QAction("Desmarca todos", contextMenuProc);
